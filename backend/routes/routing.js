...
router.post("/join-space", checkJWT, handleErrorAsync(spaceController.joinSpace));
...
router.post("/get-invite-code", checkJWT, handleErrorAsync(spaceController.getInviteCode));
router.put("/change-invite-code", checkJWT, handleErrorAsync(spaceController.changeInviteCode));
...
router.post("/find-tasks-by-space-and-userid", checkJWT, handleErrorAsync(taskController.getTasksByUserId));
router.delete("/delete-task", checkJWT, handleErrorAsync(taskController.deleteTask));
